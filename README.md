...
> The second time, **comment out 1.1 Synthetic Test Sequence: Create a small data for testing (~50 bp)** and **uncomment 1.2 RefSeq CDS and protein data (E. coli)** to run the analysis using the real biological sequences.
